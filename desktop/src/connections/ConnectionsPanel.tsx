...
// UI state; the connect/disconnect/set-active mutations arrive as props from the
// DashboardConsole (which wires them to the Tauri connection commands).

import { useState } from 'react';
import type { ProviderView, ConnectMethod } from './connections';
import type { ConnectResult } from './data';
