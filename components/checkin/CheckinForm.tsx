...
// interaction — it calls the submitCheckin server action (writing a Mood row
// that also lands on the Timeline) and, on success, resets the form and asks the
// parent to refresh. Client component: owns the form field + pending/error state.
'use client';
...
import { submitCheckin } from '@/app/lib/checkin.actions';
