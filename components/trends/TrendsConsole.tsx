// The Trends surface. Loads every metric chart, and the range switcher
// (Weekly / Monthly / Yearly) re-scopes which charts render — the page's
// primary interaction. Client component because it owns the selected-range
// state. When there is no history at all, it shows the day-one empty state.
'use client';
